...
const { CreateUser, FindUser, Login, GetUser, GetLeadersBoard, GetAllUser,
    UpdateUser, ResetPassword, DeleteAccount, GetUserById } = require('../Controller/User.Controller')
